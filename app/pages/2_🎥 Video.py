...
def get_video_names() -> list:
    if st.session_state["get_video_names"] is None:
        ...
        videos = get_videos()
        st.session_state["get_video_names"] = [Path(video).name for video in videos]
    return st.session_state["get_video_names"]
...
def session_init():
    ...
    if "get_video_names" not in st.session_state:
        st.session_state["get_video_names"] = None
