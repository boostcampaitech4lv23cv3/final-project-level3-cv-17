...
class TestYOLOv7OptimWrapperConstructor(TestCase):
    ...
    def test_build(self):
        ...
        optim_wrapper = YOLOv7OptimWrapperConstructor(optim_wrapper_cfg)(self.model)
        assert (
            optim_wrapper.optimizer.param_groups[0]["weight_decay"]
            == self.weight_decay * 2
        )
        ...
        assert (
            optim_wrapper.optimizer.param_groups[0]["weight_decay"] == self.weight_decay
        )
