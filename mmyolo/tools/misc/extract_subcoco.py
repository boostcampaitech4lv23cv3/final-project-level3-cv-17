...
def _process_data(
    args, in_dataset_type: str, out_dataset_type: str, year: str = "2017"
):
    ...
    for i in range(num_img):
        ...
        shutil.copy(image_path, osp.join(args.out_dir, out_dataset_type + year))
...
def main():
    ...
    assert args.out_dir != args.root, (
        "The file will be overwritten in place, " "so the same folder is not allowed !"
    )
