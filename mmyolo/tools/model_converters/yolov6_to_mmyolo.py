...
def convert(src, dst):
    ...
    for k, v in model.state_dict().items():
        ...
        if "ERBlock_2" in k:
            ...
            name = k.replace("upsample0.upsample_transpose", "upsample_layers.0")
        elif "upsample1" in k:
            name = k.replace("upsample1.upsample_transpose", "upsample_layers.1")
        elif "Rep_n3" in k:
...
def main():
    ...
    parser.add_argument("--src", default="yolov6s.pt", help="src yolov6 model path")
