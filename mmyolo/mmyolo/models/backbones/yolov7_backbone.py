...
class YOLOv7Backbone(BaseBackbone):
    ...
    def _build_downsample_layer(
        self, stage_idx: int, in_channels: int, out_channels: int
    ) -> Optional[nn.Module]:
